    ...
    <div className="wrapper">
      ...
      <div className='content p-40'>
        ...
        <div className='d-flex'>
          <div className='card'>
            <img width={133} height={112} src='/img/sneakers/sneakers1.jpg' alt='sneakers 1' />
          ...
          <div className='card'>
              <img width={133} height={112} src='/img/sneakers/sneakers2.jpg' alt='sneakers 1'/>
              <h5>Мужские Кроссовки Nike Blazer Mid Suede</h5>
              <div className='d-flex justify-between align-center'>
                <div className='d-flex flex-column'>
                  <span>Цена:</span>
          ...
          <div className='card'>
              <img width={133} height={112} src='/img/sneakers/sneakers3.jpg' alt='sneakers 1'/>
              <h5>Мужские Кроссовки Nike Blazer Mid Suede</h5>
              <div className='d-flex justify-between align-center'>
                <div className='d-flex flex-column'>
                  <span>Цена:</span>
          ...
          <div className='card'>
              <img width={133} height={112} src='/img/sneakers/sneakers4.jpg' alt='sneakers 1'/>
              <h5>Мужские Кроссовки Nike Blazer Mid Suede</h5>
              <div className='d-flex justify-between align-center'>
                <div className='d-flex flex-column'>
                  <span>Цена:</span>
